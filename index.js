...
console.log('-------- BDay --------')
const birthday = new Date('March 27, 1996')
const myAge = today - birthday
...
// function futureDate(date, offsetDays, repeat){
//   newDate = []
//   const futureDate = new Date(date)

//   for(let i = 0; i < repeat; i += 1){
//     futureDate.setDate(date.getDate() + offsetDays)
//     newDate.push(future.Date)
//   }
...
// }
// console.log(futureDate(new Date(), 7))
// console.log(futureDate(new Date(), - 7))
...
function consecutiveDates(date, repeat, offsetDays) {
  // Your code here          // 
  newDate = []
  const futureDate = new Date(date)
...
// 3 days apart
console.log(consecutiveDates(new Date(2019, 0, 1), 4, 4))
